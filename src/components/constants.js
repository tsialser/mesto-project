...
export const deleteCardButton = document.querySelector("#delete-button-card");
export const iconDelete = document.querySelector(".element__delete-button");
...
export const avatarLink = formEditAvatar.elements.link;
